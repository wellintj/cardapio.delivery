                ...
                <div class="right_form_login signup ">
                    <div class="login_content">
                        ...
                        <div class="form_content signup">
                            ...
                            <form action="<?= base_url('login/user_registration').$ref_id ;?>" method="post"
                                class="form-submit" autocomplete="off">
                                <?=  csrf();?>
                                <?php isset($_GET['u']) && !empty($_GET['u'])?$username = $_GET['u']:$username = ""; ?>
                                <div class="login_form">
                                    <div class="form-group">
                                        <label><i class="fa fa-user-secret"></i>
                                            <?= !empty(lang('restaurant_username'))?lang('restaurant_username'):"Restaurant name";?></label>
                                        <input type="text" name="username" id="username" class="form-control"
                                            placeholder="<?= !empty(lang('restaurant_username'))?lang('restaurant_username'):"Restaurant name";?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            placeholder="<?= !empty(lang('owner_name'))?lang('owner_name'):"Owner Name";?>"
                                            autocomplete="off">
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 card-pr-5">
                                            <label><i class="fa fa-key"></i>
                                                <?= !empty(lang('password'))?lang('password'):"password";?> </label>
                                            <input type="password" name="password" class="form-control"
                                                placeholder="<?= !empty(lang('password'))?lang('password'):"password";?>">
                                        </div>
                                        <div class="form-group col-md-6 card-pl-5">
                                            ...
                                            <input type="password" name="cpassword" class="form-control"
                                                placeholder="<?= !empty(lang('confirm_password'))?lang('confirm_password'):"confirm password";?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="pointer"> <input type="checkbox" name="terms" value="1"> &nbsp;
                                            <?= lang('read_terms'); ?> <a
                                                href="<?= base_url('terms-conditions') ?>"><?= lang('terms_condition'); ?></a>
                                    ...
                                    <div class="form-group">
                                        <p><?= !empty(lang('already_member'))?lang('already_member'):"Already a Member?";?>
                                            <a
                                                href="<?= base_url('login') ;?>"><?= !empty(lang('sign_in'))?lang('sign_in'):"sign in";?></a>
                                        </p>
                                    </div>
                                </div>
                            </form>
