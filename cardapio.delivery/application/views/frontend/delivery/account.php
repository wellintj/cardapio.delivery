                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 pnt-8">
                                    <div class="singleTab default-light">
                                        <div class="leftTab">
                                            <h4><?= currency_position($this->admin_m->get_total_earning(auth('staff_id'),3),$shop_id);?>
                                            </h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 pnt-8">
                                    <div class="singleOrder">
                                        ...
                                        <a
                                            href="<?= base_url("staff/order_details/".shop($row['shop_id'])->username."/{$row['uid']}"); ?>">
                                        ...
                                        <div class="orderDetailsBody">
                                            <div class="single_orderDetails">
                                                <p><?= $row['total_item'] ;?> item -
                                                    <?= currency_position($row['total'],$shop_id);?></p>
                                            ...
                                            <div class="singleOrdrebtn">
                                                ...
                                                <a href="<?= base_url("staff/order_details/".shop($row['shop_id'])->username."/{$row['uid']}"); ?>"
                                                    class="ongoing"><i class="icofont-spinner-alt-6"></i>
                                                    <?= lang('ongoing');?></a>
                                                <?php endif;?>

                                                <?php if($row['is_db_completed']==1): ?>
                                                <a href="javascript:;"><i class="icofont-check"></i>
                                                    <?= lang('completed'); ?></a>
                                                <a href="javascript:;"><?= !empty(lang('cod'))?lang('cod'):"COD" ;?>
                                                    <?= currency_position($row['total'],$shop_id);?></a>
                                                <?php endif;?>

                                                <?php if($row['is_picked']==1 && $row['dboy_status']==2): ?>
                                                <a href="javascript:;"><i class="icofont-concrete5"></i>
                                                    <?= lang('picked'); ?></a>
