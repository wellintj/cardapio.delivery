        ...
        <div class="col-md-6">
            <div class="d_single_order_area">
                <div class="d_single_order_header">
                    <div class="leftBtn d-flex">
                        <a href="<?= base_url('staff/new_order_list'); ?>"><i class="fa fa-angle-left"></i></a>
                        <h4># <?= $order_info['uid'] ?></h4>
                    </div>
                    <?php if ($order_info['dboy_status'] == 1 ||  $order_info['is_db_accept'] == 1 || $order_info['is_picked'] == 1) : ?>
                        <div class="rightBtn">
                            <a href="javascript:;" data-url="<?= base_url('staff/cancel_order/' . $order_info['uid'] . '/' . auth('staff_id')); ?>" class="btn btn-danger dboyCancelBtn rejectModal"> <i class="icofont-close"></i>
                                <?= !empty(lang('cancel')) ? lang('cancel') : "cancel"; ?></a>
                        </div>
                    <?php endif; ?>

                    <?php if ($order_info['dboy_status'] == 4 || $order_info['status'] == 3) : ?>
                        <div class="rightBtn">
                            <a href="javascript:;" class="btn btn-danger dboyCancelBtn"> <i class="icofont-close"></i>
                                <?= !empty(lang('canceled')) ? lang('canceled') : "canceled"; ?></a>
                        </div>
                    <?php endif; ?>
                ...
                <div class="d_single_order_body">
                    <div class="shopArea delivery-panel">
                        <div class="topd_Order pb-7">
                            <p><?= lang('shipping'); ?></p>
                            <p><b><?= $order_info['delivery_charge'] != 0 ? currency_position($order_info['delivery_charge'], $shop_id) : lang('free') ?></b>
                            </p>
                        </div>
                            ...
                            <li>
                                ...
                                <div class="shopDetails">
                                    ...
                                    <?php if (!empty($order_info['delivery_area'])) : ?>
                                        ...
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <a href="tel:<?= $order_info['phone'] ?>"><i class="icofont-phone"></i>
                                        <?= lang('call_now'); ?></a>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="orderareaDetails delivery-panel">
                                ...
                                <?php foreach ($item_list as $key => $row) : ?>
                                    ...
                                    <li>
                                        <div class="d_orderDetails">
                                            <h5><?= $row['qty']; ?> x
                                                <?= $row['is_package'] == 1 ? $row['package_name'] : $row['name']; ?> </h5>
                        ...
                        <?php if (isset($order_info['is_change']) && $order_info['is_change'] == 1 && $order_info['change_amount'] != 0) : ?>
                            <h4 class="change-amount"><?= lang('change'); ?> :
                                <?= currency_position($order_info['change_amount'], $shop_id); ?>
                            </h4>
                        <?php endif ?>
                    </div>
                    <div class="deliver-footer">
                        ...
                        <?php elseif ($order_info['dboy_status'] == 2 && $order_info['is_picked'] == 1) : ?>
                            <a href="<?= base_url('staff/completed_order/' . $order_info['uid'] . '/' . auth('staff_id')); ?>" class="btn btn-success btn-block orderBtn"> <i class="icofont-check"></i>
                                <?= !empty(lang('mark_as_completed')) ? lang('mark_as_completed') : "Mark as Completed"; ?></a>

                        <?php elseif ($order_info['dboy_status'] == 3 && $order_info['is_db_completed'] == 1) : ?>
                            <a href="javascript:;" class="btn btn-success btn-block"> <i class="icofont-check"></i>
                                <?= !empty(lang('completed')) ? lang('completed') : "Completed"; ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
