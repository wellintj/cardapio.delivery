        ...
        <div class="contact_content">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form action="<?= base_url('profile/add_reservation') ;?>" method="post" autocomplete="off"
                        class="defaultForm form-submit">
                        <!-- csrf token -->
                        <?= csrf(); ?>
                        <div class="reservation_form">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 pr-5">
                                    ...
                                    <div class="input-group date flatpickr" id="datetimepicker1"
                                        data-target-input="nearest">
                                        <input type="text" name="reservation_date" class="form-control datetimepicker"
                                            data-target="#datetimepicker1" data-input />
                                ...
                                <div class="form-group col-md-6 pl-5">
                                    ...
                                    <select name="reservation_type" class="form-control">
                                        ...
                                        <option value="<?= $row['id'] ;?>"><?= html_escape($row['name']) ;?>
                                        </option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 text-right">
                                    ...
                                    <input type="hidden" name="id" value="<?= base64_encode($shop['user_id']) ;?>">
                                    <button type="submit"
                                        class="btn btn-primary custom_btn"><?= lang('submit'); ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="col-md-4">
                    <div class="available_days">
                        <div class="appointment_schedule_area mt-10">
                            <p class="ap_info"><i class="fa fa-info-circle"></i>
                                <?= lang('booking_availabiti_text'); ?></p>
                            <?php $days = get_days(); ?>
                            <ul class="appointment_dates">
                                ...
                                <li
                                    class="<?= isset($my_days['days']) && html_escape($my_days['days'])==$key?'available':'not_available';?>">
                                    ...
                                    <b><?= isset($my_days['days']) && html_escape($my_days['days'])==$key?'( <span> '.time_format($my_days['start_time'],restaurant($id)->id).'</span> <span class="icofont-long-arrow-right timeArrow"> </span> <span>'.time_format($my_days['end_time'],restaurant($id)->id).' </span>)':'';?></b>
                                </li>
