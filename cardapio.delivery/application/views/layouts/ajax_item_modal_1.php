  ...
  <div class="modal-body item_modal">
    <div class="single_item">
      ...
      <div class="single_item_details">
        <h4><?= html_escape($item[0]['title']) ;?> <?php if(isset($item[0]['veg_type']) && $item[0]['veg_type']!=0): ?> <i class="fa fa-circle veg_type <?= $item[0]['veg_type']==1?'c_green':'c_red';?>" data-placement="top" data-toggle="tooltip" title="<?= lang(veg_type($item[0]['veg_type'])); ?>"></i><?php endif;?></h4>
