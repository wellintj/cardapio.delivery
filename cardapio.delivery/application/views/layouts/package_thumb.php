<div class="homeSingle_packages">
	...
	<div class="singleItemDetails homePackages">
		<div class="topPackageItem lineTitle">
			<h4><?= html_escape($item['title']) ;?> <?php if(isset($item['veg_type']) && $item['veg_type'] !=0): ?> <i class="fa fa-circle veg_type <?= $item['veg_type']==1?'c_green':'c_red';?>" data-placement="top" data-toggle="tooltip" title="<?= lang(veg_type($item['veg_type'])); ?>"></i><?php endif;?></h4>
