            ...
            <?php if ($limit != 0 && $total >= $limit) :  ?>
                <div class="top_cart_order">
                    <div class="limit_msg">
                        ...
                        <a href="<?= url('shop-contacts/' . $slug); ?>" class="btn btn-info custom_btn mt-15"><?= lang('contact_us'); ?></a>
                    </div>
                </div>
            <?php else : ?>
                    ...
                    <div class="top_cart_order">
                        <div class="limit_msg">
                            ...
                            <div class="offCartBtn">
                                ...
                                <a href="<?= url('shop-contacts/' . $slug); ?>" class="btn btn-secondary mt-15"><?= lang('contact_us'); ?></a>
                            </div>
                        </div>
                    </div>
