 ...
 <div class="UserResponsive_menu">
 	<div class="UserMobileMenu">
 		<ul>
 			<?php if(is_feature($id,'welcome')==1 && is_active($id,'welcome')): ?>
 				<li data-toggle="tooltip" title="<?= lang('home'); ?>" class="<?= isset($page_title) && $page_title=="Profile"?"active":"" ;?>"><a href="<?= base_url($slug) ;?>"><i class="icofont-home"></i></a></li>
 			<?php endif;?>

 			<?php if(is_feature($id,'menu')==1 && is_active($id,'menu')): ?>
	 			<li data-toggle="tooltip" title="<?= lang('menu'); ?>" class="<?= isset($page_title) && $page_title=="Menus"?"active":"" ;?>"><a href="<?= base_url('menu/'.$slug) ;?>"><i class="icofont-culinary fz-36"></i></a></li>
	 		<?php endif;?>

 			<li data-toggle="tooltip" title=""><a href="javascript:;" class="base"><i class="icofont-gears"></i></a></li>

 			<?php if(is_feature($id,'packages')==1 && is_active($id,'packages')): ?>
	 			<li data-toggle="tooltip" title="<?= lang('packages'); ?>" class="<?= isset($page_title) && $page_title=="Packages"?"active":"" ;?>"><a href="<?= base_url('packages/'.$slug) ;?>"><i class="icofont-gift"></i></a></li>
	 		<?php endif;?>

	 		<?php if(is_feature($id,'specialities')==1 && is_active($id,'specialities')): ?>
	 			<li data-toggle="tooltip" title="<?= lang('specialties'); ?>" class="<?= isset($page_title) && $page_title=="Specialties"?"active":"" ;?>"><a href="<?= base_url('specialities/'.$slug) ;?>"><i class="icofont-touch"></i></a></li>
	 		<?php endif;?>
