...
<head>
	...
	<?php if (direction() == 'rtl'): ?>
		<link rel="stylesheet" href="<?= asset_url() ?>assets/frontend/css/bootstrap-rtl.css?v=<?= $settings['version']; ?>">
		<link rel="stylesheet" href="<?= asset_url() ?>public/frontend/css/custom_rtl.css?v=<?= $settings['version']; ?>">
	<?php endif ?>
	<!-- Bootstrap CSS -->
	...
	<!-- custom loader css -->
	<link rel="stylesheet" href="<?= asset_url(); ?>assets/frontend/plugins/loader.css?v=<?= $settings['version']; ?>">
	<!-- custom loader css -->
	...
	<?php if (isset($id)): ?>
		...
		<!-- custom css -->
		<link rel="stylesheet" href="<?= asset_url(); ?>public/frontend/css/default.php?themes=<?= $u_info['theme']; ?>&theme_color=<?= $u_info['theme_color']; ?>&color=<?= $u_info['colors']; ?>">
	<?php endif; ?>
	...
	<!-- responsive css -->
	<link rel="stylesheet" href="<?= asset_url(); ?>public/frontend/css/responsive.css?v=<?= $settings['version']; ?>&t=<?= time(); ?>">
	<!-- responsive css-->
    ...
    <script src="<?= asset_url(); ?>public/frontend/js/auth.js?v=<?= $settings['version']; ?>&t=<?= time(); ?>"></script>
	<!-- ==========
   		End Default Js
    =============== -->
