                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="singleCategoryHeader">
                                                    ...
                                                    <?php if (count($type['items']) >= 8) : ?>
                                                        <a href="<?= base_url('item-types/' . $slug . '/' . md5(multi_lang($id, $type))); ?>" class="seeMore_link <?= multi_lang($id, $type); ?>"><?= lang('see_more'); ?> &nbsp;<i class="icofont-thin-double-right fw_bold"></i> </a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
