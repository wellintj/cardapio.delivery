...
<div class="row resoponsiveRow">
    ...
    <form class="email_setting_form" action="<?= base_url('admin/settings/add_appearance') ?>" method="post"
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group my-colorpicker2 colorpicker-element">
                                <input type="text" name="site_color" class="form-control" autocomplete="off"
                                    value="<?= !empty($settings['site_color'])?'#'.$settings['site_color']:"#29c7ac;";?>">
                    ...
                    <div class="row mt-20">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label class="pointer custom-radio layoutImg">
                                    <div class="layouts">
                                        <img src="<?= base_url("assets/frontend/images/dashboard_layouts/light_dashboard.png");?>"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label class="pointer custom-radio layoutImg">
                                    <div class="layouts">
                                        <img src="<?= base_url("assets/frontend/images/dashboard_layouts/dark_dashboard.png");?>"
                                            class="img-thumbnail box-shadow" alt="">
                                    </div>
