...
<div class="row resoponsiveRow">
    ...
    <form class="email_setting_form" action="<?= base_url('admin/settings/add_email_settings') ?>" method="post"
        ...
        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <label class=""><?= !empty(lang('default_email'))?lang('default_email'):"Default Email";?></label>
                                        <div class="">
                                            <select name="email_type" class="form-control email_option">
                                                <option value="2" <?= $settings['email_type']==2?'selected':''?>>
                                                 <?= lang('smtp'); ?></option>
                                                <option value="3" <?= $settings['email_type']==3?'selected':''?>>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            ...
                                            class="form-control"
                                            value="<?= !empty($settings['smtp_mail'])?html_escape($settings['smtp_mail']):'';  ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row smtpArea">
                                    <div class="smtpArea col-md-12"
                                    style="display: <?= $settings['email_type']==1 || $settings['email_type']==2?'block':'none'?>;">
                                    <div class="col-md-12">
                                    ...
                                    <?php $smtp = isJson($settings['smtp_config'])?json_decode($settings['smtp_config']):''; ?>
                                    <div class="form-group col-md-12">
                                        <label class=""><?= lang('smtp_host'); ?></label>
                                        <div class="">
                                            <input type="text" name="smtp_host" placeholder="<?= lang('smtp_host'); ?>"
                                            class="form-control"
                                            value="<?= !empty($smtp->smtp_host)?html_escape($smtp->smtp_host):'';  ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 ">
                                        ...
                                        <div class="">
                                            ...
                                            class="form-control"
                                            value="<?= !empty($smtp->smtp_port)?html_escape($smtp->smtp_port):'';  ?>"
                                            autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="">
                                            ...
                                            value="<?= !empty($smtp->smtp_password)?base64_decode($smtp->smtp_password):'';  ?>"
                                            autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 hidden">
                                        ...
                                        <div class="">
                                            <input type="password" name="send_mail_from" placeholder="do-not-reply@xxx.com"
                                            class="form-control"
                                            value="<?= !empty($smtp->smtp_password)?base64_decode($smtp->smtp_password):'';  ?>"
                                            autocomplete="off">
                                        </div>
                            ...
                            <div class="row sendGrid">
                                <div class="col-md-12 sendGrid"
                                style="display: <?= $settings['email_type']==3?'block':'none'?>;">
                                <div class="form-group col-md-12">
                                    <label><?= lang('sendgrid_api_key');?></label>
                                    <input type="text" name="sendgrid_api_key" class="form-control"
                                    value="<?= isset($settings['sendgrid_api_key'])?$settings['sendgrid_api_key']:"";?>"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group col-md-12 mt-20">
                                    ...
                                    <div class="">
                                        <a href="<?= base_url('home/test_mail') ;?>" target="_blank"
                                            class="btn btn-secondary"><?= lang('test_mail'); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <?php if(isset($settings['smtp_mail']) && !empty($settings['smtp_mail'])): ?>
            <div class="col-md-5">
                <form class="dynamic_mail_form" action="<?= base_url('admin/settings/add_email_content'); ?>" method="post"
                    enctype="multipart/form-data" autocomplete="off">
                    <?= csrf() ;?>
                            ...
                            <?php foreach ($emailType as $keys => $values): ?>
                                <div class="emailTemplate_content emailTemp <?= $keys;?> dis_none">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="subject[<?= $keys;?>]" class="form-control"
                                        value="<?= !empty($getMsg->$keys->subject)?$getMsg->$keys->subject:'';?>">
                                    </div>
                                    <div class="form-group ">
                                       ...
                                       <textarea name="message[<?= $keys;?>]" id="email_content" class="form-control data_textarea"
                                        cols="30"
                                        rows="10"><?= !empty($getMsg->$keys->message)?$getMsg->$keys->message:'';?></textarea>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
