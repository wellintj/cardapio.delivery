<div class="row">
	<div class="col-md-6">
		...
		<?php $is_clone =  isset($_GET['action']) && $_GET['action'] == 'clone' ? 1 : 0; ?>
			...
			<form action="<?= base_url('admin/settings/add_section_banner') ?>" method="post" class="skill_form" enctype="multipart/form-data">
				<div class="box-body">
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<select name="section_name" id="" class="form-control section_name <?= $is_clone == 1 ? "pointerEvent" : "" ?>">
								...
								<option value="description" <?= isset($data['section_name']) && $data['section_name'] == 'description' ? "selected" : ""; ?>>
									<?= !empty(lang('site_description')) ? lang('site_description') : "site_description"; ?> <?= lang('section'); ?>
								</option>
							</select>
						</div>
				...
				<div class="box-footer">
					...
					<div class="pull-right">
						...
						<input type="hidden" name="image" value="<?= isset($data['images']) ? $data['images'] : ""; ?>">
	...
	<div class="col-md-5 <?= $is_clone == 1 ? "hidden" : "" ?>">
		<div class="box box-primary">
			<div class="box-header with-border">
								...
								<?php foreach ($banners as $key => $row): ?>
									<tr>
										...
										<td>
											...
											<a href="<?= base_url('admin/settings/edit_section_banners/' . html_escape($row['id'])); ?>?action=clone" class="btn btn-secondary btn-sm"><i class="fa fa-copy"></i> <?= !empty(lang('clone')) ? lang('clone') : "clone"; ?></a>&nbsp;
