...
<div class="row resoponsiveRow">
    ...
    <form class="email_setting_form" action="<?= base_url('admin/settings/add_seo_settings') ?>" method="post"
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="title" id="title" class="form-control"
                                placeholder="<?= !empty(lang('title'))?lang('title'):"title";?>"
                                value="<?= isset($data['title'])?html_escape($data['title']):""; ?>">
                        </div>

                        <div class="form-group col-md-12">
                            <label><?= !empty(lang('keywords'))?lang('keywords'):"keywords";?></label>
                            <input type="text" name="keywords" id="keywords" class="form-control"
                                placeholder="<?= !empty(lang('keywords'))?lang('keywords'):"keywords";?>"
                                value="<?= isset($data['keywords'])?html_escape($data['keywords']):""; ?>">
                        </div>

                        <div class="form-group col-md-12">
                            <label
                                for="price"><?= !empty(lang('description'))?lang('description'):"sub heading";?></label>
                            <textarea name="description" id="" class="form-control " cols="10"
                                rows="5"><?= !empty($data['description'])?$data['description']:""; ?></textarea>
                        </div>
