			...
			<div class="leftSidebar">
				<ul class="flex-column">
					...
					<?php if (is_access('profile-control') == 1) : ?>
						...
						<li><a href="<?= base_url('admin/restaurant/available_days/' . md5(restaurant()->id)); ?>" class="<?= isset($page_title) && $page_title == "Available Days" ? "active" : ""; ?>"><i class="icofont-bullhorn"></i> <?= !empty(lang('available_days')) ? lang('available_days') : "Available days"; ?></a></li>
						...
						<li class="hidden"><a href="<?= base_url('admin/restaurant/location/' . md5(restaurant()->id)); ?>" class="<?= isset($page_title) && $page_title == "Locations" ? "active" : ""; ?>"><i class="icofont-map-pins"></i> <?= !empty(lang('locations')) ? lang('locations') : "locations"; ?></a></li>
						...
						<li><a href="<?= base_url('admin/restaurant/questions'); ?>" class="<?= isset($page_title) && $page_title == "Vendor Questions" ? "active" : ""; ?>"><i class="icofont-question-square"></i> <?= lang('reason_list'); ?></a></li>


						<li><a href="<?= base_url('admin/restaurant/reservation_type/' . md5(restaurant()->id)); ?>" class="<?= isset($page_title) && $page_title == "Reservation Types" ? "active" : ""; ?>"><i class="fa fa-angle-double-right"></i> <?= lang('reservation_type'); ?></a></li>
						
						
						<li><a href="<?= base_url('admin/restaurant/menu_list/'); ?>" class="<?= isset($page_title) && $page_title == "Menu List" ? "active" : ""; ?>"><i class="fa fa-angle-double-right"></i> <?= lang('menu_list'); ?></a></li>
					<?php endif; ?>
				</ul>
			</div>
		</div>
