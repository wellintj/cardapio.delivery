...
<div class="col-md-4 ">
	<div class="card box-info">
		<div class="card-header with-border">
			<h4 class="box-title"><?= lang('profile');?></h4>
		...
		<div class="card-body" >
			<div class="user_profile_view">
					<div class="image_field">
						<img src="<?= avatar(!empty($auth_info['thumb'])?$auth_info['thumb']:'','profile');?>" alt="">
					</div>
			...
			<div class="user_profile_details text-center mt-20">
				<div class="form-group profile-btn-group">
					...
					<?php if(@restaurant($auth_info['id'])->is_branding==0): ?>
						<a href="<?= base_url("admin/settings/enable_extras/{$auth_info['id']}/is_branding/1"); ?>" class="btn btn-secondary" data-toggle="tooltip" title="<?= lang('branding'); ?>"><i class="icofont-hand-drag1"></i> <?= lang('enable'); ?> <?= lang('branding'); ?>	</a>
					<?php else: ?>
						<a href="<?= base_url("admin/settings/enable_extras/{$auth_info['id']}/is_branding/0"); ?>" class="btn btn-primary action_btn" data-toggle="tooltip" title="<?= lang('branding'); ?>"><i class="icofont-hand-drag1"></i> <?= lang('disable'); ?> <?= lang('branding'); ?>	</a>
					<?php endif;?>
