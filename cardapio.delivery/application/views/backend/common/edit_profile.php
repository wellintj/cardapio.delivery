		...
		<div class="card">
			<div class="card-body">
				<div class=" d-flex justify-content-center flex-column align-center">
					<img src="<?= !empty(st()->site_qr_link) ? base_url(st()->site_qr_link) : ''; ?>" alt="big-avatar" class="big-avatar">
					<a href="<?= base_url("login/force_qr") ?>" class="label label-success action_btn" data-msg="<?= __('are_you_sure') ?>"><i class="fa fa-refresh"></i></a>
				</div>
