<div class="row resoponsiveRow">
    ...
    <form class="validForm" action="<?= base_url('admin/restaurant/create_restaurant') ?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" autocomplete="off">
        <?php $social = isJson($restaurant['social_list']) ? json_decode($restaurant['social_list'], TRUE) : ''; ?>
        <div class="col-md-5">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label class="control-label"><?= !empty(lang('restaurant_username')) ? lang('restaurant_username') : "restaurant username"; ?>
                                <span class="alert_text">* <?= lang('must_unique_english'); ?></span></label>
                        ...
                        <div class="form-group col-sm-12">
                            <label class="control-label"><?= !empty(lang('restaurant_full_name')) ? lang('restaurant_full_name') : "restaurant full name"; ?>
                                <span class="alert_text">* </span></label>
                    ...
                    <div class="row divider">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="latitude" class="form-control" value="<?= !empty($restaurant['latitude']) ? $restaurant['latitude'] : ''; ?>">
                        </div>

                        <div class="form-group col-md-6">
                            <label><?= lang("longitude"); ?></label>
                            <div class="ci-input-group  input-group-prepand">
                                <input type="text" name="longitude" class="form-control" value="<?= !empty($restaurant['longitude']) ? $restaurant['longitude'] : ''; ?>">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="time_zone" id="time_zone" class="form-control select2" required>
                                    ...
                                    <?php foreach (timezone_identifiers_list() as $key => $time) : ?>
                                        <option value="<?= $time; ?>" <?= !empty($restaurant['time_zone']) &&  $restaurant['time_zone'] == $time ? "selected" : "";  ?>>
                                            <?= $time; ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group col-sm-12">
                            <label class="control-label"><?= !empty(lang('location')) ? lang('location') : "location"; ?>
                                <span class="alert_text">* </span></label>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label class="control-label"><?= !empty(lang('about_short')) ? lang('about_short') : "about Short text"; ?>
                                (<?= lang('max'); ?> 120) <span class="alert_text">* </span></label>

                            <div class="">
                                <textarea class="form-control count_text" data-max="120" placeholder="<?= !empty(lang('about_short')) ? lang('about_short') : "about Short text"; ?>" name="about_short" required><?= !empty($restaurant['about_short']) ? $restaurant['about_short'] : ''; ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label class="control-label"><?= lang('tax_number'); ?> </label>

                            <div class="">
                                <input type="text" class="form-control" name="tax_number" placeholder="<?= !empty(lang('tax_number')) ? lang('tax_number') : "tax_number"; ?>" value="<?= !empty($restaurant['tax_number']) ? $restaurant['tax_number'] : ''; ?>">
