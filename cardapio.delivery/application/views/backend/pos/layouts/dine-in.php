			...
			<div class="tableDeatils">
				...
				<?php else : ?>
					<div class="addPersonUser">
						<span class="bg-warning-soft label mr-10"><?= lang('booked'); ?></span>
						<span href="javascript:;" class="label-danger label addmore"><?= lang('addmore');?></span>
					</div>
					<div class="addMoreArea dis_none">
						<form action="<?= base_url("admin/pos/add_table"); ?>" method="post" class="tempForm<?= $dine['id']; ?>">
							<?= csrf(); ?>
							<!-- form -->
							<div class="addtableOptin">
