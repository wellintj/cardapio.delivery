						...
						<div class="card-content">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" name="date" class="form-control datepicker pl-10" placeholder="dd/mm/aaaa" value="<?= !empty($data['created_at'])?$data['created_at']:'' ;?>">
									...
									<tr>
										...
										<td>
											<?php if(!empty($row->notes) || !empty($row->images)): ?>
												<a href="javascript:;" class="btn btn-primary btn-flat btn-sm" onclick="showImg(`<?= $row->images??'';?>`,`<?= html_escape($row->notes);?>`)"><i class="fa fa-eye"></i></a>
											<?php endif; ?>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label><?= lang('date');?> <span class="error">*</span></label>
						<div class="input-group">
							<input type="text" name="date" class="form-control datepicker pl-10" placeholder="dd/mm/aaaa" required value="<?= today();?>">
							<span class="input-group-addon"><i class="fa fa-calendar"></i></span>	
						</div>
					</div>
