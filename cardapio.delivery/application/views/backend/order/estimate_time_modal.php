...
<div id="SetTimeModal" class="modal fade setTimeModal" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/restaurant/order_status_by_ajax/'.restaurant()->id.'/1') ;?>"
                method="post" autocomplete="off" id="ajaxAccept">
                    ...
                    <div class="setTime">
                        <div class="row">
                            <div class="col-md-5 pr-5">
                                <input type="number" name="es_time" class="form-control"
                                    placeholder="<?= lang('set_time'); ?>"
                                    value="<?= !empty(restaurant()->es_time)? restaurant()->es_time: 0 ;?>" required>
                            </div>
