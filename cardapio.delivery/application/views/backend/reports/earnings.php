            ...
            <div class="card-body pt-0">
                ...
                <div id="printArea">
                    <div class="salesDropdownArea mb-5 mt-5">
                        <ul>
                            <li><a href="<?= base_url("admin/reports/earnings");?>"><span
                                        class="btn btn-gray-light"><?= lang('all_time');?></span></a></li>
                            <li><a
                                    href="<?= base_url("admin/reports/earnings/".(!empty($year)? $year:0));?>"><?= !empty($year)? '<span>/</span>'. $year:"";;?></a>
                            </li>

                            <li><a
                                    href="<?= base_url("admin/reports/earnings/".(!empty($year)? $year:0).'/'.(!empty($month)? $month:0));?>"><?= !empty($month)? '<span>/</span>'. translateDate("$year-$month-01", 'MMMM'):"";;?></a>
                            </li>
