		...
		<div class="filtercontentBody">
			<form action="" method="get" class="filterForm">
				<div class="filterBody">				
					...
					<div class="form-group">
						<label><?= lang('date'); ?> <?= !empty($this->input->get('daterange',TRUE))?" : ".$this->input->get('daterange',TRUE):'';?></label>
						<div class="input-group date">
							<input type="text" name="daterange" class="form-control dateranges" value="<?= !empty($this->input->get('daterange',TRUE))?$this->input->get('daterange',TRUE):'';?>"> 
					   ...
					   <table class="table data_tables">
					   		...
					   		<?php foreach ($top_popular_customer as $key => $customer): ?>
						   		<tr>
						   			...
						   			<td> <?=  currency_position($customer['total_amount'],restaurant()->id);?></td>
						   		</tr>
						   	<?php endforeach; ?>	
					   </table>
				  </div>
...
<script src="<?= asset_url('assets/admin/plugins/highcharts.js') ;?>"></script>
<!-- Top  item -->
<script>
	...
	Highcharts.chart('popular_customer', {
		...
		series: [{
			...
			<?php foreach ($top_popular_customer as $key => $p): ?>
				[`<?= !empty($p['customer_name'])?$p['customer_name']:"Walk-in-customer";?>`, <?= $p['total_amount'];?>],
			<?php endforeach; ?>
