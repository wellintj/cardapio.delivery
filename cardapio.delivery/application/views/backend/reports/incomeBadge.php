<?php if(!auth('is_staff')): ?>
    ...
    function formatarData($data) {
        // Verifica se a string contém um intervalo de datas
        if (strpos($data, ' - ') !== false) {
            list($dataInicio, $dataFim) = explode(' - ', $data);
            $dateInicio = new DateTime($dataInicio);
            $dateFim = new DateTime($dataFim);
            return $dateInicio->format('d/m/Y') . ' a ' . $dateFim->format('d/m/Y');
        } else {
    ...
    $dataOntemFormatada = $dataOntem->format('d/m/Y');
    ?>
                ...
                <div class="info-box bg-purple">
                    ...
                    <div class="info-box-content">
                        ...
                        <div class="currencyDate">
                            ...
                            <small style="font-weight: bold; font-size: 14px; color: white"><?= $dataOntemFormatada; ?></small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="info-box bg-aqua">
                    ...
                    <div class="info-box-content">
                        ...
                        <div class="progress">
                            <div class="progress-bar" style="width: <?= percent_diff($nextlastmonth->amount,$lastmonth->amount);?>%"></div>
                        </div>
                        <div class="currencyDate">
                            <span class="progress-description">
                            ...
                            <small style="font-weight: bold; font-size: 14px; color: white"><?= formatarData($lastmonth->date);?></small>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="info-box bg-green">
                    ...
                    <div class="info-box-content">
                        ...
                        <div class="currencyDate">
                            ...
                            <small style="font-weight: bold; font-size: 14px; color: white"><?= formatarData($last7->date);?></small>
                        </div>
                    </div>
                </div>
            </div>
