							...
							<tbody>
								...
								foreach ($faq as $row): ?>
									<tr>
										...
										<td>
											<a href="<?= base_url('admin/home/edit_faq/' . html_escape($row['id'])); ?>?action=clone" class="btn btn-secondary btn-sm"><i class="fa fa-copy"></i> <?= !empty(lang('clone')) ? lang('clone') : "clone"; ?></a>
											<a href="<?= base_url('admin/home/edit_faq/' . html_escape($row['id'])); ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> <?= !empty(lang('edit')) ? lang('edit') : "edit"; ?></a>
