		...
		<div class="box box-primary">
			...
			<form action="<?= base_url('admin/home/add_services') ?>" method="post" class="skill_form" enctype="multipart/form-data">
				<div class="box-body">
					...
					<div class="row">
							<?php __languageField('col-md-6'); ?>
					</div>
					<div class="row mt-15">
						<div class="form-group col-md-12">
							<div class="serviceImg adminService" style="display:<?= isset($data['images']) && !empty($data['images']) ? 'block' : 'none'; ?>;">
								<img src="<?= !empty($data['images']) ? avatar($data['images'],'logo') : ''; ?>" class="service_icon_preview" alt="">
							</div>
							...
							<tbody>
								...
								foreach ($services as $row): ?>
									<tr>
										...
										<td>
											<a href="<?= base_url('admin/home/edit_services/' . html_escape($row['id'])); ?>?action=clone" class="btn btn-secondary btn-sm"><i class="fa fa-copy"></i> <?= !empty(lang('clone')) ? lang('clone') : "clone"; ?></a>
											<a href="<?= base_url('admin/home/edit_services/' . html_escape($row['id'])); ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> <?= !empty(lang('edit')) ? lang('edit') : "edit"; ?></a>
