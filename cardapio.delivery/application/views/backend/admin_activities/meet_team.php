							...
							<tbody>
								...
								foreach ($team as $row): ?>
									<tr>
										...
										<td>
											<div class="serviceImgs"><img src="<?= avatar($row['thumb'], 'logo'); ?>" /></div>
										</td>
										<td>
										...
										<td>
											<a href="<?= base_url('admin/home/edit_team/' . html_escape($row['id'])); ?>?action=clone" class="btn btn-secondary btn-sm"><i class="fa fa-copy"></i> <?= !empty(lang('clone')) ? lang('clone') : "clone"; ?></a>
