							...
							foreach ($packages as $key => $value): ?>
								<?php if (count($value['items']) > 0): ?>
									<tr>
										...
										<td data-label="<?= lang('name'); ?>"><?= html_escape($value['package_name']); ?>
												...
												<table class="table table-bordered ">
													...
													<tbody>
														...
														foreach ($value['items'] as $row): ?>
															<tr>
																<td data-label="<?= __("sl"); ?>"><?= $j; ?></td>
																<td data-label="<?= __("images"); ?>">
																	<div class="serviceImg">
																		<img src="<?= base_url($row['item_thumb']); ?>" alt="">
																	</div>
																</td>
																<td data-label="<?= __("title"); ?>"><?= html_escape($row['title']); ?></td>
																<td data-label="<?= __("price"); ?>"><?= currency_position($row['item_price'], restaurant()->id); ?></td>
															</tr>
														<?php $j++;
														endforeach ?>
													</tbody>
