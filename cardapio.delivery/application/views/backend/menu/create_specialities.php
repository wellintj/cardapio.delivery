				...
				<div class="box-body">
					...
					<div class="row">
						...
						<div class=" form-group col-md-12">
							...
							<textarea name="details" id="" cols="5" rows="5" class="form-control data_textarea" placeholder=" <?= !empty(lang('details')) ? lang('details') : "Details"; ?>"><?= !empty($data['details']) ? html_escape($data['details']) : set_value('details'); ?></textarea>
						</div>
					</div>
