        ...
        <div class="col-md-5">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title fz-14">
                        <?php if (isset($is_edit)) {
                            echo lang('edit');
                        } elseif (isset($is_clone)) {
                            echo lang('clone');
                        } else {
                            echo lang('create_category');
                        } ?></h3>

                    - <small class="text-purple fz-15"><i class="fa fa-language"></i> <?= lang_slug($_GET['lang'] ?? site_lang()); ?></small>
                ...
                <form action="<?= base_url('admin/menu/add_category') ?>" method="post" class="validForm" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 <?= isset($is_clone) && $is_clone == 1 ? "" : "hidden" ?>">
                            ...
                            <div class="from-group col-md-6 <?= isset($is_clone) && $is_clone == 1 ? "mt-25" : "" ?> mb-10">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody id="sortable" class="sortable sorting">
                                    ...
                                    foreach ($menu_type as $row) : ?>
                                        <tr id='<?= $row['id']; ?>'>
                                            <td data-label="<?= lang('sl'); ?>" class="handle"><?= $i; ?></td>
                                            <td data-label="<?= lang('image'); ?>" class="handle">
                                                <div class="serviceImgs">
                                                    <img src="<?= get_img($row['thumb'], '', 1); ?>" alt="">
                                                </div>

                                            </td>
                                            <td data-label="<?= lang('category_id'); ?>" class="handle"><?= multi_lang(auth('id'), $row); ?></td>
                                            <td data-label="<?= lang('title'); ?>" class="handle"><?= html_escape($row['name']); ?></td>
