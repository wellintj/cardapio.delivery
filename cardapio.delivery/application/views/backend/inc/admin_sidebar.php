     ...
     <ul class="treeview-menu">
         <li class="<?= $page_title == "Total Users" ? "active" : ""; ?>">
             <a href="<?= base_url('admin/dashboard/total_users') ?>">
                 <i class="fa fa-users"></i>
                 <span><?= !empty(lang('total_restaurant')) ? lang('total_restaurant') : "total restautant"; ?></span>
             </a>
         </li>

         <li class="<?= $page_title == "Clone Shop" ? "active" : ""; ?> hidden">
             <a href="<?= base_url('admin/queue/cloneShop') ?>">
                 <i class="fa fa-plus"></i>
                 <span><?= !empty(lang('clone_a_restaurant')) ? lang('clone_a_restaurant') : "Clone a restaurant"; ?></span>
             </a>
         </li>
     </ul>
 </li>
         ...
         <ul class="treeview-menu">
             <li class="<?= isset($page) && $page == "Settings" ? "active" : ""; ?>">
                 <a href="<?= base_url('admin/settings/settings') ?>">
                     <i class="fa fa-cog"></i>
                     <span><?= !empty(lang('site_settings')) ? lang('site_settings') : "Site Settings"; ?></span>
                 </a>
             </li>
             ...
             <li class="<?= $page_title == "Home Banner Settings" ? "active" : ""; ?>">
                 <a href="<?= base_url('admin/settings/banner_settings') ?>">
                     ...
                     <span><?= !empty(lang('home_banner_setting')) ? lang('home_banner_setting') : "Banner settings"; ?></span>
                 </a>
             </li>
             ...
             <?php if (auth('user_role') == 1 && !auth('is_staff')) : ?>
                 ...
                 <li class="<?= $page_title == "Upgrade" ? "active" : ""; ?>">
                     <a href="<?= base_url('admin/dashboard/upgrade/'); ?>">
                         ...
                         <span><?= !empty(lang('upgrade_license')) ? lang('upgrade_license') : "Upgrade License"; ?></span>
                     </a>
                 </li>
         ...
         <ul class="treeview-menu">
             ...
             <li class="<?= $page_title == "Packages" ? "active" : ""; ?>">
                 <a href="<?= base_url('admin/dashboard/packages') ?>">
                     ...
                     <span><?= !empty(lang('package_list')) ? lang('package_list') : "Package List"; ?></span>
                 </a>
             </li>
             <li class="<?= $page_title == "Order Types" ? "active" : ""; ?>">
                 <a href="<?= base_url('admin/dashboard/order_types') ?>">
                     <i class="fa fa-angle-double-right"></i>
                     <span><?= !empty(lang('order_types')) ? lang('order_types') : "Order Types"; ?></span>
                 </a>
             </li>
             ...
             <li class="<?= $page_title == "Features" ? "active" : ""; ?>">
                 <a href="<?= base_url('admin/dashboard/features') ?>">
                     <i class="fa fa-angle-double-right"></i>
                     <span><?= !empty(lang('features')) ? lang('features') : "Features"; ?></span>
                 </a>
             </li>
         ...
         <ul class="treeview-menu">
             ...
             <li class="<?= $page_title == "Services" ? "active" : ""; ?>">
                 <a href="<?= base_url('admin/home/services') ?>">
                     <i class="fa fa-angle-double-right"></i>
                     <span><?= !empty(lang('services')) ? lang('services') : "Services"; ?></span>
                 </a>
             </li>
             ...
             <li class="<?= $page_title == "Site Features" ? "active" : ""; ?>">
                 <a href="<?= base_url('admin/home/site_features') ?>">
                     <i class="fa fa-angle-double-right"></i>
                     <?= !empty(lang('site_features')) ? lang('site_features') : "Site Features"; ?>
                 </a>
             </li>
             ...
             <li class="<?= $page_title == "How It Works" ? "active" : ""; ?>">
                 <a href="<?= base_url('admin/home/how_it_works') ?>">
                     <i class="fa fa-angle-double-right"></i>
                     <?= !empty(lang('how_it_works')) ? lang('how_it_works') : "how it works"; ?>
                 </a>
             </li>
             ...
             <li class="<?= $page_title == "Tutorials" ? "active" : ""; ?>">
                 <a href="<?= base_url('admin/home/tutorials') ?>">
                     <i class="fa fa-angle-double-right"></i> <?= lang('tutorials'); ?> <span><?= is_new('3.1.6'); ?></span>
                 </a>
             </li>

             <li class="<?= $page_title == "Cities" ? "active" : ""; ?>">
 ...
 <?php if (is_access('Language-control') == 1) : ?>
     ...
     <li class="treeview <?= isset($page) && $page == "Languages" ? "active" : ""; ?>">
         ...
         <ul class="treeview-menu">
             ...
             <li class="<?= $page_title == "Dashboard Language" ? "active" : ""; ?>"><a href="<?= base_url('admin/home/dashboard_languages') ?>"><i class="fa fa-angle-double-right"></i>
                     <?= !empty(lang('language_data')) ? lang('language_data') : "Languages Data"; ?></a></li>
             ...
             <ul class="treeview-menu">
                 ...
                 <?php if (__config('is_affiliate') == 1) : ?>
                     <li class="<?= $page_title == "Payout Request" ? "active" : ""; ?>">
                         <a href="<?= base_url('admin/affiliate/payout_request') ?>">
                             <i class="fa fa-angle-double-right"></i> <span><?= lang('payout_request'); ?></span>
                         </a>
                     </li>

                     <li class="<?= $page_title == "Completed Payout" ? "active" : ""; ?>">
                         <a href="<?= base_url('admin/affiliate/completed_payout') ?>">
                             <i class="fa fa-angle-double-right"></i> <span><?= lang('completed_payout'); ?></span>
                         </a>
                     </li>

                     <li class="<?= $page_title == "Affiliate List" ? "active" : ""; ?>">
                         <a href="<?= base_url('admin/affiliate/affiliate_list') ?>">
                 ...
                 <li class="<?= $page_title == "Affiliate Settings" ? "active" : ""; ?>">
                     <a href="<?= base_url('admin/affiliate/') ?>">
                         <i class="fa fa-angle-double-right"></i>
                         <span><?= !empty(lang('settings')) ? lang('settings') : "Settings"; ?></span>
                     </a>
                 </li>
         ...
         <ul class="treeview-menu">
             ...
             <li class="<?= isset($page_title) && $page_title == "Create Pages" ? "active" : ""; ?>">
                 <a href="<?= base_url('admin/dashboard/pages') ?>">
                     <i class="fa fa-angle-double-right"></i>
                     <span><?= !empty(lang('add_page')) ? lang('add_page') : "Add Pages"; ?></span>
                 </a>
             </li>
             ...
             <li class="<?= isset($page_title) && $page_title == "Terms & Conditions" ? "active" : ""; ?>">
                 <a href="<?= base_url('admin/dashboard/terms') ?>">
                     <i class="fa fa-angle-double-right"></i>
                     <span><?= !empty(lang('terms_condition')) ? lang('terms_condition') : "Terms & Conditions"; ?> </span>
                 </a>
             </li>
             ...
             <li class="<?= isset($page_title) && $page_title == "Cookies & Privacy" ? "active" : ""; ?>">
                 <a href="<?= base_url('admin/dashboard/privacy') ?>">
                     <i class="fa fa-angle-double-right"></i>
                     <span><?= !empty(lang('cookies_privacy')) ? lang('cookies_privacy') : "Cookie & Privacy"; ?> </span>
                 </a>
             </li>
         ...
         <ul class="treeview-menu">
             ...
             <li class="<?= isset($page_title) && $page_title == "Permission List" ? "active" : ""; ?>">
                 <a href="<?= base_url('admin/adminstaff/permission_list') ?>">
                     <i class="fa fa-angle-double-right"></i>
                     <?= !empty(lang('permission_list')) ? lang('permission_list') : "permission_list"; ?></span>
                 </a>
             </li>
         </ul>
     </li>
         ...
         <?php if (check() == 1) : ?>
             <li class="<?= isset($page_title) && $page_title == "Custom Domain" ? "active" : ""; ?> <?= is_package; ?>">
                 <a href="<?= base_url('admin/dashboard/domain_list') ?>">
                     ...
                     <span><?= !empty(lang('domain_list')) ? lang('domain_list') : "Domain List"; ?><?php if ($this->admin_m->count_table_by_status(0, 'custom_domain_list') > 0) : ?>
                         <span class="notify"><?= $this->admin_m->count_table_by_status(0, 'custom_domain_list'); ?></span><?php endif; ?></span>
                 </a>
             </li>
         <?php endif; ?>
     <?php endif; ?>
 ...
 <?php if (is_access('review-control') == 1) : ?>
     <li class="<?= isset($page_title) && $page_title == "Shop Reviews" ? "active" : ""; ?>">
         <a href="<?= base_url('admin/dashboard/shop_reviews') ?>">
             <i class="fa fa-star-o"></i>
             <span><?= !empty(lang('shop_reviews')) ? lang('shop_reviews') : "Shop Reviews"; ?></span>
         </a>
     </li>
 <?php endif; ?>
 ...
 <li class="treeview <?= isset($page) && $page == "Payments" ? "active" : ""; ?>">
     <a href="#">
         <i class="icofont-pay fz-20"></i>
         <span><?= !empty(lang('transactions')) ? lang('transactions') : "transactions"; ?></span>
         <span class="pull-right-container">
             <i class="fa fa-angle-left pull-right"></i>
         </span>
     </a>
     <ul class="treeview-menu">
         ...
         <li class="<?= $page_title == "Offline Payments" ? "active" : ""; ?>">
             <a href="<?= base_url('admin/dashboard/offline_payments') ?>">
                 <i class="fa fa-credit-card-alt"></i>
                 <span><?= !empty(lang('offline_payments')) ? lang('offline_payments') : "Offline Payments"; ?><?php if ($this->admin_m->count_table_by_status(0, 'offline_payment') > 0) : ?>
                     <span class="notify"><?= $this->admin_m->count_table_by_status(0, 'offline_payment'); ?></span><?php endif; ?></span>
             </a>
         </li>
         <li class="<?= $page_title == "Transactions" ? "active" : ""; ?>">
             <a href="<?= base_url('admin/dashboard/transactions') ?>">
                 <i class="fa fa-exchange"></i>
                 <span><?= !empty(lang('user_transaction')) ? lang('user_transaction') : "User's Transactions"; ?> </span>
             </a>
         </li>
 ...
 <?php if (!auth('is_staff')) : ?>
     <?php if (isset($pusher_config->status) && $pusher_config->status == 1) : ?>
         <?php if (!auth('is_staff')) : ?>
             <li class="<?= $page_title == "Chat" ? "active" : ""; ?>">
                 <a href="<?= base_url("admin/chat"); ?>">
                     <i class="fa fa-comments fz-20"></i> <span><?= lang('chat'); ?></span>
                 </a>
             </li>
         <?php endif ?>
     <?php endif; ?>
 ...
 <?php if (!auth('is_staff')) : ?>
     <li class="<?= $page_title == "Site Map" ? "active" : ""; ?>">
         <a href="<?= base_url('sitemap/sitemap'); ?>">
             <i class="icofont-ui-rate-add"></i> <span><?= lang('sitemap'); ?></span>
         </a>
     </li>

     <?php if (check() == 1) : ?>
         <li class="treeview <?= isset($page) && $page == "Malicious" ? "active" : ""; ?> <?= is_package ?>">
             <a href="#">
                 <i class="icofont-danger-zone fz-20 text-danger"></i>
                 <span><?= !empty(lang('malicious')) ? lang('malicious') : "malicious"; ?></span>
                 <span class="pull-right-container">
             ...
             <ul class="treeview-menu">
                 <li class="<?= $page_title == "Malicious" ? "active" : ""; ?>">
                     <a href="<?= base_url("admin/dashboard/malicious"); ?>">
                         <i class="icofont-danger-zone fz-20 text-danger"></i> <span><?= !empty(lang('malicious')) ? lang('malicious') : "malicious"; ?></span>
                     </a>
                 </li>

                 <li class="<?= $page_title == "User Attempts" ? "active" : ""; ?>">
                     <a href="<?= base_url('admin/dashboard/user_attempts') ?>">
                         <i class="fa-solid fa-user-ninja"></i>
                         <span><?= !empty(lang('user_attempts')) ? lang('user_attempts') : "User Attempts"; ?></span>
                     </a>
                 </li>

                 <li class="<?= $page_title == "Settings" ? "active" : ""; ?> ">
                     <a href="<?= base_url('admin/dashboard/msettings') ?>">
                         <i class="fa fa-cogs"></i>
                         <span><?= !empty(lang('settings')) ? lang('settings') : "settings"; ?></span>
                     </a>
                 </li>
