			...
			<div class="card">
				<div class="card-body">
					<div class="row">
						...
						<div class="form-group col-sm-12 <?= isset(st()->is_city_delivery) && st()->is_city_delivery == 1 ? '' : 'hidden'; ?>">
							<label class="control-label"><?= !empty(lang('city_name')) ? lang('city_name') : "city_name"; ?><span class="alert_text">* </span></label>

							<div class="">
								<select name="city_id" id="" class="form-control select2">
									<option value=""><?= lang('select'); ?></option>
									<?php foreach ($cityList as $key => $city): ?>
										<option <?= isset($restaurant['city_id']) && $restaurant['city_id'] == $city['id'] ? "selected" : "";; ?> value="<?= $city['id']; ?>"><?= $city['city_name']; ?> <?= !empty($city['state']) ? ' - ' . $city['state'] : '' ?></option>
									<?php endforeach ?>
								</select>
							</div>
						</div>
						...
						<div class="form-group col-sm-12">
							...
							<select name="number_formats" class="form-control">
								...
								<option value="5" <?= isset($restaurant['number_formats']) && $restaurant['number_formats'] == 5 ? "selected" : "";; ?>>1.000.000</option>
								<option value="6" <?= isset($restaurant['number_formats']) && $restaurant['number_formats'] == 6 ? "selected" : "";; ?>>1000.000</option>
							</select>
						</div>
					...
					<div class="row pt-10 gray-color">
						...
						<div class="rows">
							...
							<div class="form-group col-md-12">
								<label><?= !empty(lang('tiktok')) ? lang('tiktok') : "tiktok"; ?></label>
								<div class="input-group">
									<span class="input-group-addon"><i class="fab fa-tiktok"></i></span>
									<input type="text" name="tiktok" class="form-control" placeholder="<?= !empty(lang('tiktok')) ? lang('tiktok') : "tiktok"; ?>" value="<?= !empty($social['tiktok']) ? html_escape($social['tiktok']) : ""; ?>">
								</div>
