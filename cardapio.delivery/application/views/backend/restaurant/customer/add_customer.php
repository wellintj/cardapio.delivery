					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group col-md-12">
								...
								<input type="text" name="name" id="name" class="form-control" placeholder="<?= !empty(lang('name')) ? lang('name') : "Name"; ?>" value="<?= !empty($data['customer_name']) ? html_escape($data['customer_name']) : ''; ?>">
							</div>
							<div class="form-group col-md-12">
