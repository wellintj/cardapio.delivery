<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12 col-lg-8">
		<div class="box box-primary">
			...
			<!-- /.box-header -->
			<form action="<?= base_url('admin/restaurant/add_staff') ?>" method="post" class="skill_form" enctype= "multipart/form-data">
				<div class="box-body">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group col-md-12">
						      	<label for="price"><?= !empty(lang('permission'))?lang('permission'):"Permission";?></label>
						        <div class="features">
