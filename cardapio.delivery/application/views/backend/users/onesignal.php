                            ...
                            <div class="row">
                               ...
                               <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12 mt-5">
                                 ...
                                 <div class="form-group col-md-12 mt-5">
                                    <label class="custom-checkbox"><input type="checkbox" name="is_call_waiter_push" value="1" <?= isset($notification->is_call_waiter_push) && $notification->is_call_waiter_push==1 ? "checked" : ""; ?>><?= lang('enable_push_for_call_waiter'); ?></label>
                                </div>
                        </div>
