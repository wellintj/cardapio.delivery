		...
		<form action="<?= base_url('admin/coupon/create_coupon'); ?>" method="post" class="validForm">
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						...
						<div class="form-group col-md-12">
							...
							<div class="input-group">
								...
								<span class="input-group-addon btn btn-default"><label class="pointer d-flex-center generateCode" onclick="makeid(8)"><?= lang('new_code'); ?></label></span>
							</div>
					...
					<div class="row">
						<div class="form-group col-md-6">
							...
							<div class="input-group" dir="ltr">
								<input type="text" name="start_date" class="form-control datepicker pl-10" placeholder="dd/mm/yyyy" value="<?= !empty($data['start_date']) ? date('d/m/Y', strtotime($data['start_date'])) : ''; ?>">
						...
						<div class="form-group col-md-6">
							...
							<div class="input-group" dir="ltr">
								<input type="text" name="end_date" class="form-control datepicker pl-10" placeholder="dd/mm/yyyy" required value="<?= !empty($data['end_date']) ? date('d/m/Y', strtotime($data['end_date'])) : ''; ?>">
								<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-6">
							<label class="custom-checkbox label bg-purple-soft-active pl-5"><input type="checkbox" name="is_menu" value="1" <?= isset($data['is_menu']) && $data['is_menu']==1? "checked" : ''; ?>> <?= lang('show_in_landing_page'); ?></label>
						</div>
					</div>
				</div><!-- card-body -->
