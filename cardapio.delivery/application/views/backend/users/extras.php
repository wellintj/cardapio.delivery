        ...
        <form action="<?= base_url("admin/auth/add_extra_config");?>" method="post">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="m-0 mr-5"><?= lang('extras');?> </h5>
                </div>
                <div class="card-body">
                    <div class="card-content">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <select name="language_type" id="language_type" class="form-control"
                                    ...
                                    <option value="system"
                                        <?= isset($apps->language_type) && $apps->language_type=="system"?"selected":"";?>
                                        selected><?= lang('system_language');?></option>
                                    <option value="google"
                                        <?= isset($apps->language_type) && $apps->language_type=="google"?"selected":"";?>>
                        ...
                        <div class="languages_section">
                            <div
                                class="languageItems system <?= isset($language_type) && $language_type=="system"?"":"dis_none";?>">
                                ...
                                <ul>
                                    ...
                                    <li><label class="custom-checkbox"><input type="checkbox" name="languages[]"
                                                value="<?= $lang->slug;?>"
                                                <?= isset($language) && !empty($language) &&  in_array($lang->slug, $language)==1?"checked":"" ;?>>
                                            <?= $lang->lang_name;?></label></li>
                                    <?php endforeach ?>
                                </ul>
                                ...
                                <div class="row">
                                    <div class="mt-10 col-md-4">
                                        ...
                                        <select name="system_default_language" id="languages"
                                            class="form-control select2">
                                            <?php foreach (get_languages() as $key => $lang) : ?>
                                            <option value="<?= $lang->slug;?>"
                                                <?= isset($apps->system_default_language) && $apps->system_default_language==$lang->slug?"selected":"";?>>
                        ...
                        <div class="thirdparty-app">
                            ...
                            <div class="form-group">
                                ...
                                <select name="app" id="Third-party" class="form-control">
                                    <option value="1" <?= isset($apps->app) && $apps->app=='elfsight'?"selected":"";?>>
                                        Elfsight</option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="app_id" class="form-control"
                                    value="<?= isset($apps->app_id)?$apps->app_id:'';?>"
                                    placeholder="<?= lang('app_id');?>">
                            </div>

                            <div class="form-group">
                                <label><?= lang('app_id');?> (<small><?= lang('cookies_privacy');?></small>)</label>
                                <input type="text" name="app_id_cookies" class="form-control"
                                    value="<?= isset($apps->app_id_cookies)?$apps->app_id_cookies:'';?>"
                                    placeholder="<?= lang('app_id');?>">
                            </div>

                            <div class="form-group">
                                <label class="custom-radio-2 mr-10"><input type="radio" name="elfsight_status" value="1"
                                        <?= isset($apps->elfsight_status) && $apps->elfsight_status==1?"checked":"";?>
                                        checked><?= lang('active');?></label>
                                <label class="custom-radio-2"><input type="radio" name="elfsight_status" value="0"
                                        <?= isset($apps->elfsight_status) && $apps->elfsight_status==0?"checked":"";?>><?= lang('deactive');?></label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="pagination_limit" class="form-control"
                                    value="<?= isset($apps->pagination_limit)?$apps->pagination_limit:15;?>">
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="is_scroll_top" id="is_scroll_top" class="form-control">
                                    <option value="1"
                                        <?= isset($apps->is_scroll_top) && $apps->is_scroll_top==1?"selected":'';?>>
                                        <?= lang('enable');?></option>
                                    <option value="0"
                                        <?= isset($apps->is_scroll_top) && $apps->is_scroll_top==0?"selected":'';?>>
                                        <?= lang('disable');?></option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="edit_order_type" id="edit_order_type" class="form-control">
                                    <option value="0"
                                        <?= isset($apps->edit_order_type) && $apps->edit_order_type==0?"selected":'';?>>
                                        <?= lang('order_details');?></option>
                                    <?php if (file_exists(APPPATH.'controllers/admin/Pos.php')) : ?>
                                    <option value="1"
                                        <?= isset($apps->edit_order_type) && $apps->edit_order_type==1?"selected":'';?>>
                                        <?= lang('pos');?></option>
                                    <?php endif; ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="item_limit" class="form-control"
                                    value="<?= isset($apps->item_limit)?$apps->item_limit:8;?>">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class=" form-group col-md-12">
                                ...
                                <textarea name="terms" id="terms" cols="30" rows="10"
                                    class="form-control data_textarea"><?= isset($apps->terms)?json_decode($apps->terms):'';?></textarea>
                            </div>
                        </div>
                    </div><!-- card-content -->
                </div><!-- card-body -->
