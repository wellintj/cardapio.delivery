                                    ...
                                    <div class="custom-control order-preference custom-switch prefrence-item ml-10">
                                        ...
                                        <div class="topContent">
                                            <div class="gap">
                                                ...
                                                <label for="<?= $types['slug']; ?>" class="switch-label"> <span class="toggle--on">
                                        ...
                                        <?php if (check() == 1) : ?>
                                                ...
                                                <?php if (isset($is_payment) && $is_payment == 1) : ?>
                                                    <?php if ($types['slug'] != 'pay-in-cash' && $types['is_admin_enable'] == 1) : ?>
                                                        <div class="left_payment_op <?= is_package; ?>">
                                                            <label class="custom-checkbox">
                                                                <input type="checkbox" name="is_payment[<?= $types['id']; ?>]" value="<?= $types['id']; ?>" <?= isset($types['is_payment']) && $types['is_payment'] == 1 ? "checked" : ""; ?>>
                                                                <?= lang('enable_payment') ?>
                                                            </label>
                                                        </div>
                                                        <div class="left_payment_op <?= is_package; ?>">
                                                            <label class="custom-checkbox">
                                                                <input type="checkbox" name="is_required[<?= $types['id']; ?>]" value="<?= $types['id']; ?>" <?= isset($types['is_required']) && $types['is_required'] == 1 ? "checked" : ""; ?>>
                                                                <?= lang('payment_required') ?>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <?php else : ?>
                                                        <div class="left_payment_op hidden">
                                                            <label class="custom-checkbox">
                                                                <input type="checkbox" name="is_payment[<?= $types['id']; ?>]" value="<?= $types['id']; ?>" <?= overlay == 1 ? "checked" : ""; ?>>
                                                                <?= lang('enable_payment') ?>
                                                            </label>
                                                        </div>
                                                        <div class="left_payment_op hidden">
                                                            <label class="custom-checkbox">
                                                                <input type="checkbox" name="is_required[<?= $types['id']; ?>]" value="<?= $types['id']; ?>" <?= overlay == 1 ? "checked" : ""; ?>>
                                                                <?= lang('enable_payment') ?>
                                                            </label>
                                                        </div>
                                                    <?php endif; ?>
                                            ...
                                            <div class="left_payment_op <?= is_package; ?>">
                                                <label class="custom-checkbox">
                                                    <input type="checkbox" name="is_service_charge[<?= $types['id']; ?>]" value="<?= $types['id']; ?>" <?= isset($types['is_service_charge']) && $types['is_service_charge'] == 1 ? "checked" : ""; ?>>
                                                    <?= lang('service_charge') ?>
                                                </label>
                                            </div>
                                        <?php endif; ?>
