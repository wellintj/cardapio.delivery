		...
		<div class="box-footer no-border">
			<div class="row">
				<div class="col-xs-4 text-center revenue_text">
					<h4><?= currency_format($this->admin_m->user_total_income_in_year(0),restaurant()->id);?></h4>
					<p><?= lang('total_revenue'); ?></p>
				</div>

				<div class="col-xs-4 text-center revenue_text">
					<h4><?= currency_format($this->admin_m->user_total_income_in_year('year'),restaurant()->id);?> </h4>
					<p><?= lang('total_revenue'); ?> (<?= date('Y');?>)</p>
				</div>

				<div class="col-xs-4 text-center revenue_text">
					<h4><?= currency_format($this->admin_m->user_total_income_in_year('month'),restaurant()->id);?> </h4>
