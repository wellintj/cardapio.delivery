...
if ($db->table_exists($table) && ($check_domain['is_domain'] == 1 || $check_domain['is_subdomain'] == 1)) {
	...
	if ($result > 0) :
		...
		if (($result->is_subdomain == 1 || $result->is_domain == 1) && $result->status == 2 && $result->is_ready == 1) :
			...
			$route['page/(:any)'] = 'profile/single_page/$1';
			$route['vpage/(:any)'] = 'profile/vendor_page/$1';
			$route['pagadito-success'] = 'user_payment/pagadito_success';
			// new
			$route['shop-reviews'] = 'profile/review';
			$route['terms-condition'] = 'profile/terms';
			$route['subcategory/(:any)'] = 'profile/subcategory/$1';
			$route['offers/(:any)'] = 'profile/offers/$1';
		else :
...
$route['offers/(:any)/(:any)'] = 'profile/offers/$1/$2';
...
$route['vpage/(:any)/(:any)'] = 'profile/vendor_page/$1/$2';
...
$route['payment/check_mercado_pix_status'] = 'profile/check_mercado_pix_status';
$route['webhook/mercado-pix'] = 'user_payment/mercado_pix_webhook';
...
//New
$route['subcategory/(:any)/(:any)'] = 'profile/subcategory/$1/$2';
...
$route['page/(:any)/(:any)'] = 'profile/single_page/$1/$2';
