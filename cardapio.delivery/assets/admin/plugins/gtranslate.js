 (function () {
    ...
    widget_css +=
        u_class + " .gt_switcher .gt_selected{background:" + switcher_background_color + " linear-gradient(180deg, " + switcher_background_shadow_color + " 0%, " + switcher_background_color + " 70%);position:relative;z-index:9999}";
