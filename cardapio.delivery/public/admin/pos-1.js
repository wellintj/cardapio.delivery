...
function setPickupDetails() {
    ...
    if (!pickupArea || !pickupTime || !pickupDate || !pickupId) {
        alert("Por favor, preencha todos os campos para retirada.");
        return false;
    }

    // Converter data para formato brasileiro (DD/MM/YYYY)
    var pickupDateFormatted = pickupDate.split('-').reverse().join('/');
...
function pickupTime() {
    ...
    $(".datepicker-3").flatpickr({
        enableTime: false,
        dateFormat: "d/m/Y", // Alterado para formato brasileiro
