-- Adicionar método de pagamento PIX na tabela payment_method_list se não existir
INSERT INTO payment_method_list (name, slug, active_slug, status_slug) 
VALUES ('PIX', 'pix', 'is_offline', 'offline_status') 
ON DUPLICATE KEY UPDATE 
    name = 'PIX', 
    active_slug = 'is_offline', 
    status_slug = 'offline_status';

-- Adicionar o idioma português para o PIX
...
VALUES 
    ...
    ('after_payment_confirmation_click_below', 'Após confirmar o pagamento, clique no botão abaixo', 'After confirming the payment, click the button below'),
